...
public class ActivityFive extends Activity {
    ...
    private final static String TAG = "ActivityFive";
    
    
    @Override
	protected void onCreate(Bundle savedInstanceState) {
    	Log.i(TAG, "Entered the onCreate() method, ActivityFive");
    	super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_five);
		RelativeLayout root = (RelativeLayout)findViewById(R.id.actfive);
